  ...
  async function handleSubmit(e) {
    ...
    try {
      if (mode === 'signup') {
        ...
        // Check onboarding status on sign-in too
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-md p-5 sm:p-8 w-full max-w-md">
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-lg py-2.5 px-4 text-sm font-semibold text-gray-700 hover:bg-gray-50 transition-colors mb-4 disabled:opacity-60"
        >
